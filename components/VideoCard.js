...
const VideoCard = ({ title, thumbnail, channelName, views, avatar }) => {
    return (
        <div className={`${nunito.className} video-card cursor-pointer gap-2 shrink-0 flex flex-col justify-between max-h-[16rem] max-w-[22rem] h-[21.5rem] w-[31.25rem] bg-secondary/0 rounded`}>
